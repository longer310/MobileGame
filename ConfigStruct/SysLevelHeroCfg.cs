...
namespace MobileGame.tianzi.ConfigStruct
{
    ...
    /// 副本NPC武将配置
    /// </summary>
    public class SysLevelHeroCfg : TableCfg<SysLevelHeroCfg>
    {
        /// <summary>
        /// NpcId
        /// </summary>
        ...
        public void Init()
        {
            if (Force == 0)
            {
                ...
                var sql = string.Format("UPDATE SysLevelHeroCfg SET `Force`={1},`Intel`={2},`Command`={3},`Ap`={4},`AdArm`={5},`ApArm`={6},`Hp`={7},`AttackSpeed`={8},`MoveSpeed`={9},`AdCrit`={10},`Block`={11},`Blood`={12},`HpRecovery`={13},`EnergyRecovery`={14},`Range`={15},`Ad`={16},`ApCrit`={17},`Combat`={18} WHERE `Id`={0};",
